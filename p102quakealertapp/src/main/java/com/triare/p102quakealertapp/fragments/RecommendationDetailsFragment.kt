 ...
 * Use the [RecommendationDetailsFragment.newInstance] factory method to
...
class RecommendationDetailsFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment RecommendationDetailsFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            RecommendationDetailsFragment().apply {
